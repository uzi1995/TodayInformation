...
public class MvpControler implements ILifeCircle{
    ...
    @Override
    public void onActivityCreated(Bundle saveInstanceState, Intent extras, Bundle getArguments) {
        ...
        while (var3.hasNext()) {
            ...
            presenter.onActivityCreated(saveInstanceState, extras, getArguments);
        }
    }
